		...
		<div>
			...
			<div id="wrapper">
				<section id="intro" className="wrapper style1 fullscreen fade-up">
					<div className="inner">
						<h1 className="main-title">Southern Help Tech</h1>
						<p>Welcome to Southern Help Tech we provide simple, affordable solutions to your most challenging technological needs.</p>
						...
						<div className="split style1">
							...
							<section>
								<ul className="contact">
									<li>
										<h3>Address</h3>
										<span>Galax, VA 24333<br />
										USA</span>
									</li>
									<li>
										<h3>Email</h3>
										<a href="#">kevin@southernhelptech.com</a>
									</li>
									<li>
										<h3>Phone</h3>
										<span>(276) 233-3568</span>
									</li>
									<li>
										<h3>Social</h3>
										<ul className="icons">
			...
			<footer id="footer" className="wrapper style1-alt">
				<div className="inner">
					<ul className="menu">
						<li>&copy; Untitled. All rights reserved.</li><li>Design: Kevin</li>
					</ul>
				</div>
			</footer>
		</div>
